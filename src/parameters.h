...
struct EKF_par
{
    ...
    double sigma_uv; // (pixels) camera measurement noise standard deviation Features 
    double sigma_uv_anchor; // (pixels) camera measurement noise standard deviation Anchors         
    ...
    double sigma_sp;  // speed measurment noise;
    double sigma_att_update; // for attitude updates
    double min_vel_start_init;
